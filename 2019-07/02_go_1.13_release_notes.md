...
SSL バージョン 3.0 (SSLv3) のサポートは[廃止予定になり、Go 1.14 で削除される予定です](https://golang.org/issue/32716). SSLv3 は[暗号的には壊れており](https://tools.ietf.org/html/rfc7568)、`crypto/tls` ではすでにデフォルト無効であり、Go のクライアントでサポートされていないことに注意してください.
